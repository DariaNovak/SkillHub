...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20251021153835_AddValueIdToUserEntity")]
    partial class AddValueIdToUserEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Courses.Course", b =>
                {
                    ...
                    b.HasIndex("AuthorId1")
                        .HasDatabaseName("ix_courses_author_id1");
            ...
            modelBuilder.Entity("Domain.Courses.Course", b =>
                {
                    b.HasOne("Domain.Users.User", "Author")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_courses_users_author_id1");
